      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) CREATE CHECKOUT FORM + PROCESS / CHARGE THE CREDIT CARD
