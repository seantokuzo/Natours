...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2VhbnRva3V6byIsImEiOiJjbDJ2ZHdrMGYwNDduM2NxdTdkcTd2OGFpIn0.vvHzOrFuK5dtnDUmhVg4ZA';
...
var stripe = Stripe('pk_test_51KxfBCK3JkI6Fn4egVjVkFVH612tdJoTFweewXmm9YBqIjfQOdnlMSLpjTJuAUGj7uUoA7oASACSron62f6i5uDv0047Dk4pfs');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Password successfully reset!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var forgotPasswordForm = document.querySelector('.form--forgotpass');
var logOutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var passwordResetForm = document.querySelector('.form--reset-password');
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var sendLinkBtn = document.getElementById('send-reset-btn');
...
if (passwordResetForm) {
  passwordResetForm.addEventListener('submit', function (e) {
    ...
    var submitBtn = document.getElementById('reset-password-btn');
    var token = submitBtn.dataset.token;
